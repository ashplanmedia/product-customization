...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Product Customization') }}</div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <select id="product_type" name="img_path" class="form-control">
                                ...
                                <option value="avita_purple.png">Avita Purple</option>
                                <option value="urban_ruby.png">Urban Ruby</option>
                                <option value="sunflower_yellow.png">Sunflower Yellow</option>
